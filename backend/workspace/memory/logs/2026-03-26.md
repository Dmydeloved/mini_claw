...
--header 'apikey:mkt_nZCdGEigegMGTaA7loqDmaOtK5tYBoO-NmCHdeCyPcU' \
--data '{"query":"立讯精密的资讯"}'
```
...
帮我将这个skill添加到skills中

**Assistant**: 模型调用失败：SafeShellTool._run() got an unexpected keyword argument 'commands'
